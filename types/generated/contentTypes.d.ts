...
export interface ApiCartCart extends Schema.CollectionType {
  ...
  attributes: {
    ...
    lastname: Attribute.String;
    shoe: Attribute.Relation<'api::cart.cart', 'manyToOne', 'api::shoe.shoe'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiRatingRating extends Schema.CollectionType {
  ...
  attributes: {
    ...
    car: Attribute.Relation<'api::rating.rating', 'oneToOne', 'api::car.car'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiShoeShoe extends Schema.CollectionType {
  ...
  attributes: {
    ...
    price: Attribute.Integer;
    image: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    carts: Attribute.Relation<'api::shoe.shoe', 'oneToMany', 'api::cart.cart'>;
    imageUrl: Attribute.Text;
    type: Attribute.String;
    category: Attribute.String;
